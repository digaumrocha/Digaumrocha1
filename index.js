      ...
      try {
        ...
        const embed = new EmbedBuilder()
          ...
          .setDescription(
            ...
            "IMPORTANT: :redsiren: You can register your wallet adress at any time, but doing so now ensures that we can always grant you community activity rewards immediately, as well as your WL if you win. (it's secure, no authentication required).\n" +
            "Want to do this now?"
          );
